...
public:
    ...
    void writeGeometry(geos::geom::GeometryFactory& context, const geos::geom::Geometry& geom);
    void writeGeometryCollection(geos::geom::GeometryFactory& context, const geos::geom::Geometry& multi);
